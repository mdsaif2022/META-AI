...
module.exports = {
	...
	langs: {
		vi: {
			noUpdates: "✅ | Bạn đang sử dụng phiên bản mới nhất của META AI (v%1).",
			updatePrompt: "💫 | Bạn đang sử dụng phiên bản %1. Hiện tại đã có phiên bản %2. Bạn có muốn cập nhật chatbot lên phiên bản mới nhất không?"
				...
				+ "\n%3%4"
				+ "\n\nℹ️ | Xem chi tiết tại https://github.com/mdsaif2022/Goat-Bot-V2/commits/main"
		...
		en: {
			noUpdates: "✅ | You are using the latest version of META AI (v%1).",
			updatePrompt: "💫 | You are using version %1. There is a new version %2. Do you want to update the chatbot to the latest version?"
				...
				+ "\n%3%4"
				+ "\n\nℹ️ | See details at https://github.com/mdsaif2022/Goat-Bot-V2/commits/main"
